...
/// Import the krypt pallet.
pub use pallet_krypt;
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("node-hodl"),
	impl_name: create_runtime_str!("node-hodl"),
	authoring_version: 1,
...
// Configure the pallet-krypt in pallets/krypt.
parameter_types! {
	pub const MaxTokenSupplyKrypt : u128 = 21_000_000;
}

impl pallet_krypt::Config for Runtime {
	type Event = Event;
	type Balance = Balance;
	type MaxTokenSupply = MaxTokenSupplyKrypt;
}

parameter_types! {
	pub const MaxTokenSupplyKryptoKurrency : u32 = 100_000;
}

impl pallet_kryptokurrency::Config for Runtime {
	type Event = Event;
	type Balance = Balance;
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Sudo: pallet_sudo,
		Krypt: pallet_krypt,
		KryptoKurrency: pallet_kryptokurrency,
	}
);
